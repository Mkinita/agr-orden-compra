...
export default function AdminPedidos() {
    ...
    const fetcher = () => axios('/api/listado-pedidos').then(datos => datos.data)
    const { data, error, isLoading } = useSWR('/api/listado-pedidos',fetcher,{refreshInterval: 100} )
    ...
    return(
        <AdminLayout pagina={'Listado-OC'}>
            ...
            <h1 className="text-2xl font-black text-center">Informe Pedidos Central</h1>
