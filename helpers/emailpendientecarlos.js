...
const recipients = ['carlos.vera.aparicio@gmail.com'];
...
async function sendEmail({ to, subject, text }) {
  const mailOptions = {
    ...
    html: `
      ...
      <a href="https://agr-orden-compra-production.up.railway.app/carlos-pendientes">Sistema/Compras/Agrifor/Carlos/Pendientes</a>.
      <p></p>
