        ...
        <div class="rounded-xl bg-gray-200 bg-opacity-50 px-16 py-5 shadow-lg backdrop-blur-md max-sm:px-8">
                ...
                <div className="px-32"></div>
                    ...
                    <div className="grid grid-cols-1">
                            ...
                            <div >
                                <div className='mb-4 text-lg'>
                                <div className="mb-4 text-lg">
                                    <h1 className="rounded-3xl border-none bg-gray-400 bg-opacity-50 px-6 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md">NOTIFICACION ENVIADA</h1>
                                </div>
                                </div>
                            </div>
            ...
            <div class="mt-8 flex justify-center text-lg text-black">
                ...
                {pedido01.map(oc => (
                    <div key={oc.id}>
                        <div className="m-auto">
                            <div className="rounded-3xl bg-yellow-400 bg-opacity-50 px-10 py-2 text-black shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-yellow-600">
                                <Link href={`/ordenes/${id}`} className=""> Visualizar
                                </Link>
                            </div>
                        </div>
                    </div>
