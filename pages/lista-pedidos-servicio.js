...
import ListadoPedidosServicio from '../components/ListadoPedidosServicio'
...
export default function AdminPedidos() {
    ...
    const fetcher = () => axios('/api/listado-pedidos-servicio').then(datos => datos.data)
    const { data, error, isLoading } = useSWR('/api/listado-pedidos-servicio',fetcher,{refreshInterval: 100} )
    ...
    const URL = '/api/listado-pedidos-servicio'
    ...
    return(
        <AdminLayout pagina={'Listado-OC'}>
            ...
            <h1 className="text-2xl font-black text-center">Informe Pedidos COL</h1>
