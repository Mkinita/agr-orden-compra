  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-4 items-center">
        ...
        <div className="md:w-4/6">
            <p className="text-lg font-bold">{equipo.detalle}</p>
            <p className="text-sm font-bold mt-2">Cantidad: {equipo.cantidad}</p>
            <p className="text-sm text-gray-700 mt-2">Volumen: {equipo.espesor * equipo.ancho * equipo.largo * equipo.piezas *equipo.cantidad / 1000000 }</p>
        ...
        <button
            ...
            onClick={() => handleEditarCantidades(equipo.id)}
         >
