...
const OrdenGeneral = ({ solicitud }) => {
  const { id, nombre01, fecha, estado01, compra, cotizar, planta, estado } = solicitud;
        ...
        <table className="w-full text-xs">
            <tbody>
                <tr className="bg-white">
                    ...
                    <td className="px-2  w-1/4 text-center">{estado01 ? "✔️" : "Pendiente"}</td>
                    <td className="px-2  w-1/4 text-center">{estado ? "✔️" : "Pendiente"}</td>
