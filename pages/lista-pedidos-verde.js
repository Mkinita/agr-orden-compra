...
import ListadoPedidosVerde from '../components/ListadoPedidosVerde'
...
export default function AdminPedidos() {
    ...
    const fetcher = () => axios('/api/listado-pedidos-verde').then(datos => datos.data)
    const { data, error, isLoading } = useSWR('/api/listado-pedidos-verde',fetcher,{refreshInterval: 100} )
    ...
    const URL = '/api/listado-pedidos-verde'
    ...
    return(
        <AdminLayout pagina={'Listado-OC'}>
            ...
            <h1 className="text-2xl font-black text-center">Informe Pedidos Verde</h1>
