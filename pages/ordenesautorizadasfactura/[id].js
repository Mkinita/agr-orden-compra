...
import OrdenPdfAutorizadafactura from '@/components/OrdenPdfAutorizadafactura'
...
export default function OrdenPage({ orden }) {
  ...
  return (
    <>
        ...
        <OrdenPdfAutorizadafactura orden={orden} />
        </div>


        <button className="m-auto hidden lg:block" onClick={() => window.print()}>
...
export async function getServerSideProps(context) {
  ...
  const orden = await prisma.nuevaorden.findUnique({
