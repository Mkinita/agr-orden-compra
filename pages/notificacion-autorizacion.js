...
export default function ContactPage() {
    ...
    useEffect(() => {
        if (data) {
          ...
          setFormData({
            ...
            text: `Tu orden de compra fue autorizada`,
          });
        }
      }, [data]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('/api/sendMailAutorizacion', formData);
  ...
  return (
    <LayoutAutorizar pagina='Notificar O.C.'>
    <form onSubmit={handleSubmit}>
      ...
      <div className='p-2 w-1/2 text-center shadow rounded-lg px-6 m-auto'>
        <p className='font-bold text-s'>Esta notificación se enviará por correo electrónico para dar aviso de la autorizacion</p>
        <br/>
        <br/>
