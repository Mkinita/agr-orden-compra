...
export default function Admin() {
    ...
    const fetcherOrden = () => axios('/api/ordenes-autorizadas-sup-carlosvera').then(datos => datos.data)
    const { data:dataOrden, error:errorOrden, isLoading:isLoadingOrden } = useSWR('/api/ordenes-autorizadas-sup-carlosvera',fetcherOrden,{refreshInterval: 100} )
