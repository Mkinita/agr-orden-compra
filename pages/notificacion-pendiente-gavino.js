...
export default function ContactPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('/api/sendMailMasivaGanino', formData);
    ...
    setTimeout(() =>{
      router.push('/notificacion-pendiente-carlos')
    },1500)
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className='p-2 w-1/2 text-center shadow rounded-lg px-6 m-auto'>
        ...
        <p className=' font-extrabold text-2xl'>/NOTIFICACION PENDIENTE GAVINO/</p>
        <br/>
        <br/>
