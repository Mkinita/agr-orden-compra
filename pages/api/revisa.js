const paddockManagers = [
    ...
    const paddocks = [
        ...
        for (const paddock of paddocks) {
            ...
            const farm = farms.find(f => f.id === paddock.farmId);
            const type = paddockType.find(t => t.id === paddock.paddockTypeId);

            datos.push({
                paddockManager: paddockManager.name,
                farm: farm.name,
                paddockType: type.name,
                harvestYear: paddock.harvestYear,
                area: paddock.area
            });
        }
